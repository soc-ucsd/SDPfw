...
%read_name = 'LR120_trans_box_1_2_cons_3';
%read_name = 'LR24_trans_box_cons_2';
%read_name = 'LR120_disk2_box_cons_3';
read_name = 'LR18_cons_4';
...
[model_cons_trans.A, model_cons_trans.b, model_cons_trans.c, model_cons_trans.K] ...
    = convert_mosek2sedumi(res_cons_trans.prob);
...
%save(strcat(read_name, '.mat'), 'model_cons_trans', 'res_cons_trans')
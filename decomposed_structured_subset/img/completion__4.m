...
%     
    ...
    %out = struct;
    load(strcat('sos_quartic_', num2str(N), '.mat'), 'out', 'model_dd_star_dual')
    ...
    %out.dd_dual = draw_feasibility(model_dd_star_dual, 'dd', th);
    %out.dd_dual = draw_feasibility_dual(model_dd_dual, 'psd', th, 0);
    C = linspecer(6);
